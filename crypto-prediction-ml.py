...
test_data = web.DataReader(f'{crypto_currency}-{pair_currency}', 'yahoo', test_start, test_end)
...
#if you want to predict ahead you have to feed it its own prediction graph -1 day and real graph -2 price values
